...
if(process.platform == 'linux') {
  var cmds = {
    'volup': 'amixer -q -D pulse sset Master 3%+',
    'voldown': 'amixer -q -D pulse sset Master 3%-',
    'mute': 'amixer -q -D pulse sset Master toggle',
    'opencd': 'eject',
    'closecd': 'eject -t',
    'monitoroff': 'xset dpms force off',
    'monitoron': 'xset dpms force on',
    'stop': 'pkill node',
    'hardstop': 'pkill node',
    'screen': 'import -window root img/screen.jpg',
    'explorer': 'nautilus',
    'desktop': 'xdotool key ctrl+super+d',
